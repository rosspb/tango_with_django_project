...
def visitor_cookie_handler(request):
    ...
    # we use the COOKIES.get() funcition to obtain the visits cookie
    # if the cookie exists, the value returned is casted to an integer
    # if the cookie does not exist, then default value of 1 is used
    ...
    if (datetime.now() - last_visit_time).days > 0:
        visits = visits + 1
        # update the last_visit cookie now we have updated the count
